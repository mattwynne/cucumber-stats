...
all: reports/pulls.latest.csv reports/first-pr.latest.csv reports/contributor-flow.latest.csv reports/open-issues.latest.csv reports/responsiveness.latest.csv
